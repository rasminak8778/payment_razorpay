...
from odoo.addons.payment_razorpays.controllers.main import RazorpayController
...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_processing_values(self, processing_values):
        ...
        if self.provider_code != 'razorpays':
            return res
    ...
    #     self._handle_notification_data('razorpays', response_content)
    #
    #     return child_capture_tx
    #
    ...
    #     if provider_code != 'razorpays' or len(tx) == 1:
    #         return tx
    #
